...
//function needs to be arrow function, as in remove: () => otherwise it would run immediately

//decrease needs to know amount because decreasing item less than 1 needs to remove it
